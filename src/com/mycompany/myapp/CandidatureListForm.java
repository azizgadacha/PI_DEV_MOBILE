...
public class CandidatureListForm extends Form {
    ...
    public void remplir(Form previous,Container CandidatureContainer,ArrayList<Container> containerListeListe){
        ...
        for (candidature user : candidatures) {
            ...
            MakeRDV.addActionListener(e -> {
                RendezVousAdd form =  new RendezVousAdd(user,previous) ;
        form.show();
            });
       ...
       // form.AddRendezVous();
            ...
            deleteBtn.addActionListener(e -> {
              ...
              CandidatureListForm form =  new CandidatureListForm(  previous) ;
       form. show();
               //showNourrituresList(theme);
...
CandidatureContainer.repaint();
    ...
    public CandidatureListForm( Form previous) {
...
CandidatureContainer.repaint();
                ...
                remplir( previous,CandidatureContainer,containerListeListe);
            });
